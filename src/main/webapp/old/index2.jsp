...
<body>
	<c:if
		...
		<a href="/AuthController/Spotify" class="spotify fixedlogin btn">
			<i class="fa fa-spotify fa-fw"></i>
			<span class="spotify-full-text">Iniciar Sesión</span>
			<span class="spotify-short-text">Log in</span>
		</a>
	</c:if>
	<c:if
		test='${sessionScope["Spotify-token"] != null && sessionScope["Spotify-token"] != ""}'>
		<a href="#" class="spotify fixedlogin btn"> <i
			class="fa fa-spotify fa-fw"></i>
			<span class="spotify-full-text">Conectado a Spotify</span>
			<span class="spotify-short-text">Conectado</span>
			...
			<div class="d-flex justify-content-center">
				<div class="searchbar">
					<input class="search_input" type="text" name="searchQuery"
						placeholder="Buscar lyrics" required><a href="javascript:{}"
