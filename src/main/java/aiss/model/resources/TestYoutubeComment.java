...
public class TestYoutubeComment {
    private static final String CLIENT_SECRETS= "FqWVOGY88BXZMI4wltSqt4Fn";
    ...
    public static Credential authorize(final NetHttpTransport httpTransport) throws IOException {
        // Load client secrets.
        InputStream in = TestYoutubeComment.class.getResourceAsStream(CLIENT_SECRETS);
