...
public class SpotifyResourceOld {

    private static final Logger log = Logger.getLogger(SpotifyResourceOld.class.getName());

    private final String access_token;
    private final String baseURL = "https://api.spotify.com/v1";

    public SpotifyResourceOld(String access_token) {
