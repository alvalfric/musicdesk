...
@JsonPropertyOrder({ "watching_count", "olson_path", "calendar_count", "comment_count", "region_abbr", "postal_code",
		"going_count", "all_day", "latitude", "groups", "url", "id", "privacy", "city_name", "link_count", "longitude",
		"country_name", "country_abbr", "region_name", "start_time", "tz_id", "description", "modified",
		"venue_display", "tz_country", "performers", "title", "venue_address", "geocode_type", "tz_olson_path",
		"recur_string", "calendars", "owner", "going", "country_abbr2", "image", "created", "venue_id", "tz_city",
...
public class Event {
	...
	// Custom Properties
	public String getDateInSpanish() {
		Locale spanishLocale=new Locale("es", "ES");
		LocalDateTime localDate = LocalDateTime.parse(this.start_time, DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"));
	    String dateInSpanish=localDate.format(DateTimeFormatter.ofPattern("dd MMMM, yyyy",spanishLocale)); 
	    return dateInSpanish.substring(0, 1).toUpperCase() + dateInSpanish.substring(1);
    }
