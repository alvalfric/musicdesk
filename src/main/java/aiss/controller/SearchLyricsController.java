 ...
 */
public class SearchLyricsController extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static final Logger log = Logger.getLogger(SearchLyricsController.class.getName());
	private static String query = "";

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public SearchLyricsController() {
		super();
	}
